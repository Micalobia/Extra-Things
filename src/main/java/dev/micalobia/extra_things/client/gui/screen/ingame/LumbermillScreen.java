...
public class LumbermillScreen extends HandledScreen<LumbermillScreenHandler> {
	...
	public LumbermillScreen(LumbermillScreenHandler handler, PlayerInventory inventory, Text title) {
	...
	protected void drawMouseoverTooltip(MatrixStack matrices, int x, int y) {
		...
		if(this.canCraft) {
			...
			List<LumbermillRecipe> list = this.handler.getAvailableRecipes();
